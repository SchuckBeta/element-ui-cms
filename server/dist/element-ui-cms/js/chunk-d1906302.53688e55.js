  ...
  ["chunk-d1906302", "chunk-2d0f0b62"],
  {
      ...
      (function(t) {
        ...
        var c = function(e) {
            ...
            var t,
              ...
              a = f(e.Query || e.params || {}),
              c = f(e.Headers || e.headers || {}),
              u = e.Key || "";
            if (
              (e.UseRawKey
                ? (t = e.pathname || "/" + u)
            ...
            if (!r) return console.error("missing param SecretKey");
            var l = function(e) {
                var t = [];
            ...
            var m = "sha1",
              ...
              x = l(a)
                .join(";")
                .toLowerCase(),
              k = o.HmacSHA1(C, r).toString(),
              w = [i, t, d(a), d(c), ""].join("\n"),
              S = ["sha1", v, o.SHA1(w).toString(), ""].join("\n"),
              T = o.HmacSHA1(S, k).toString(),
              R = [
                "q-sign-algorithm=" + m,
                "q-ak=" + y,
                "q-sign-time=" + v,
        ...
        var b = function(e) {
          ...
          w = function(e, t) {
            if (
              ...
              t &&
                ...
                (n["x-cos-copy-source-Range"] = t["CopySourceRange"]),
                (n["x-cos-metadata-directive"] = t["MetadataDirective"]),
                (n["x-cos-copy-source-If-Modified-Since"] =
                  t["CopySourceIfModifiedSince"]),
                (n["x-cos-copy-source-If-Unmodified-Since"] =
                  t["CopySourceIfUnmodifiedSince"]),
                (n["x-cos-copy-source-If-Match"] = t["CopySourceIfMatch"]),
                (n["x-cos-copy-source-If-None-Match"] =
                  t["CopySourceIfNoneMatch"]),
                (n["x-cos-acl"] = t["ACL"]),
                ...
                (n["x-cos-server-side-encryption-customer-algorithm"] =
                  t["SSECustomerAlgorithm"]),
                (n["x-cos-server-side-encryption-customer-key"] =
                  t["SSECustomerKey"]),
                (n["x-cos-server-side-encryption-customer-key-MD5"] =
                  t["SSECustomerKeyMD5"]),
                (n["x-cos-server-side-encryption"] = t["ServerSideEncryption"]),
                (n["x-cos-server-side-encryption-cos-kms-key-id"] =
                  t["SSEKMSKeyId"]),
                (n["x-cos-server-side-encryption-context"] = t["SSEContext"]),
                (t.Headers = l(n)));
            }
            return t;
          },
          S = function(e, t) {
            return function(n, r) {
              "function" === typeof n && ((r = n), (n = {})), (n = w(e, n));
              var o = function(e) {
                  return (
                    e &&
                      e.headers &&
              ...
              if ("getService" !== e && "abortUploadTask" !== e) {
                var a;
                if ((a = k(e, n)))
                  return void i({ error: "missing param " + a });
                if (n.Region) {
          ...
          A = {
            ...
            uuid: x,
            camSafeUrlEncode: s,
            throttleOnProgress: T,
            getFileSize: R,
            isBrowser: !0
          };
        (A.localStorage = t.localStorage),
          (A.fileSlice = function(e, t, n) {
            return e.slice
              ? e.slice(t, n)
              : e.mozSlice
                ? e.mozSlice(t, n)
          ...
          (A.getFileUUID = function(e, t) {
            return e.name && e.size && e.lastModifiedDate && t
              ? A.md5([e.name, e.size, e.lastModifiedDate, t].join("::"))
              : null;
          }),
          (A.getBodyMd5 = function(e, n, r) {
            (r = r || u),
              e
                ? "string" === typeof n
                  ? r(A.md5(n, !0))
                  : n instanceof t.Blob
                    ? A.getFileMd5(n, function(e, t) {
                        r(t);
                      })
                    : r()
                : r();
        ...
        o = function() {
          ...
          return (
            ...
            (this.parseXML = function(n, r) {
              ...
              if (u)
                for (var l, d, p, f = 0; f < n.childNodes.length; f++)
                  (l = n.childNodes.item(f)),
                    4 === l.nodeType
                      ? e.mergeCDATA && (c += l.nodeValue)
                      : 3 === l.nodeType
                        ? (c += l.nodeValue)
                        : 1 === l.nodeType &&
                          (0 === s && (a = {}),
    ...
    "1ac6": function(e, t, n) {
      ...
      function s(e, t) {
        var n,
          ...
          g = e.Key,
          m = e.Body,
          v = e.ChunkSize || e.SliceSize || o.options.ChunkSize,
          b = e.AsyncLimit,
          x = e.StorageClass || "Standard",
        ...
        s.on("error", function(e) {
            ...
            C.call(
              ...
              function(t, i) {
                if (o._isRunningTask(u)) {
                  if ((delete c[e.UploadId], t))
                    return r(null, !0), s.emit("error", t);
                  r({ loaded: n, total: n }, !0),
                    p.call(o, e.UploadId),
                    s.emit("upload_complete", i);
                }
              }
            );
          }),
          s.on("get_upload_data_finish", function(t) {
            var i = a.getFileUUID(m, e.ChunkSize);
            i && d.call(o, i, t.UploadId),
              (c[t.UploadId] = !0),
              u &&
                o.on("inner-kill-task", function(e) {
                  e.TaskId === u &&
                    "canceled" === e.toState &&
                    delete c[t.UploadId];
                }),
              y.call(
                ...
                function(e, t) {
                  if (o._isRunningTask(u))
                    return e
                      ? (r(null, !0), s.emit("error", e))
                      : void s.emit("upload_slice_complete", t);
                }
              );
          }),
          s.on("get_file_size_finish", function() {
            if (
              ((r = a.throttleOnProgress.call(o, n, e.onProgress)),
              e.UploadData.UploadId)
            )
              s.emit("get_upload_data_finish", e.UploadData);
            else {
              var t = a.extend(
                {
                  TaskId: u,
          ...
          (function() {
            for (
              ...
              if (((r = 1024 * t[i] * 1024), n / r <= o.options.MaxPartNumber))
                break;
            e.ChunkSize = e.SliceSize = v = Math.max(v, r);
          })(),
          0 === n
            ? ((e.Body = ""),
              (e.ContentLength = 0),
              (e._OnlyUploadNotAddTask = !0),
              o.putObject(e, function(e, n) {
                if (e) return t(e);
                t(null, n);
              }))
      ...
      var c = {},
        u = "cos_sdk_upload_cache";
      function l() {
        var e = this.options.UploadIdCacheLimit;
        if (!r) {
          if (e)
            try {
              r = JSON.parse(a.localStorage.getItem(u)) || [];
            } catch (t) {}
          r || (r = []);
        }
      }
      function d(e, t, n) {
        ...
        r.length > i && r.splice(i),
          i &&
            setTimeout(function() {
              try {
                a.localStorage.setItem(u, JSON.stringify(r));
              } catch (e) {}
            });
      }
      function p(e) {
        l.call(this), delete c[e];
      ...
      function h(e, t) {
        ...
        S.on("error", function(e) {
                ...
                function(e, t) {
                  d._isRunningTask(n) &&
                    (c[e]
                      ...
                      : m.call(
                          d,
                          { Bucket: r, Region: s, Key: u, UploadId: e },
                          function(r, o) {
                            if (d._isRunningTask(n)) {
                              if (r) return p.call(d, e), S.emit("error", r);
                              var i = o.PartList;
            ...
            if (i && (o = f.call(d, i))) {
              var l = function(e) {
                if (e >= o.length) S.emit("has_upload_id", t);
                  ...
                  var i = o[e];
                  if (!a.isInArray(t, i)) return p.call(d, i), void l(e + 1);
                  c[i]
                    ? l(e + 1)
                    : m.call(
                        d,
                        { Bucket: r, Region: s, Key: u, UploadId: i },
                        function(t, r) {
                          d._isRunningTask(n) &&
                            (t
                              ? (p.call(d, i), l(e + 1))
          ...
          S.on("get_remote_upload_id_list", function(t) {
            g.call(d, { Bucket: r, Region: s, Key: u }, function(t, r) {
              if (d._isRunningTask(n)) {
                if (t) return S.emit("error", t);
                var o = a
      ...
      function y(e, t) {
        var n = this,
          ...
          y = a.filter(u.PartList, function(e) {
            return (
      ...
      function b(e, t) {
        ...
        if (
          ...
          g.call(u, { Bucket: n, Region: r }, function(e, n) {
            if (e) return t(e);
            l.emit("get_abort_array", n.UploadList || []);
          });
        else if ("file" === s) {
          if (!o) return t({ error: "abort_upload_task_no_key" });
          g.call(u, { Bucket: n, Region: r, Key: o }, function(e, n) {
            if (e) return t(e);
            l.emit("get_abort_array", n.UploadList || []);
          });
        } else {
        ...
        a.each(e.files, function(e, t) {
          (function() {
            ...
            var y = e.onFileFinish,
              ...
              C = c >= r ? "sliceUploadFile" : "putObject";
            p.push({ api: C, params: e, callback: v });
          })();
        }),
          n._addTasks(p);
      }
      function w(e, t) {
        ...
        if (d) {
          ...
          n.on("copy_slice_complete", function(e) {
            ...
            n.on("get_file_size_finish", function() {
              (function() {
                for (
                  ...
                  if (
                    ((n = 1024 * t[o] * 1024), m / n <= r.options.MaxPartNumber)
                  )
                    break;
                e.ChunkSize = v = Math.max(v, n);
                for (var i = Math.ceil(m / v), a = [], s = 1; s <= i; s++) {
                  var c = (s - 1) * v,
                    u = s * v < m ? s * v - 1 : m - 1,
                    l = {
                      PartNumber: s,
                ...
                r.multipartInit({ Bucket: s, Region: c, Key: u }, function(
                  r,
                  o
                ) {
                  if (r) return t(r);
            ...
            r.headObject({ Bucket: p, Region: f, Key: h }, function(o, i) {
              o
      ...
      e.exports.init = function(e, t) {
        t.transferToTaskMethod(T, "sliceUploadFile"),
    ...
    "749c": function(e, t) {
      ...
      var o = "http://www.w3.org/1999/xhtml",
        ...
        k = ((v.NOT_SUPPORTED_ERR = ((C[9] = "Not supported"), 9)),
      ...
      function N(e, t, n) {
        var r = E(t, n);
        if (!(r >= 0)) throw w(x, new Error(e.tagName + "@" + n));
        var o = t.length - 1;
        while (r < o) t[r] = t[++r];
        if (((t.length = o), e)) {
            ...
            for (b = 0; b < y; b++) {
              ...
              if (ne(x, n, i)) {
                var k = x.prefix || "",
                  w = x.namespaceURI,
                  S = k ? " xmlns:" + k : " xmlns";
                t.push(S, '="', w, '"'), i.push({ prefix: k, namespace: w });
              }
              re(x, t, n, r, i);
            }
            if (ne(e, n, i)) {
      ...
      function ie(e, t, n) {
        ...
        switch (
          ...
          case a:
            var c = t.attributes,
              u = (r.attributes = new A()),
              l = c.length;
            u._ownerElement = r;
            for (var d = 0; d < l; d++)
              r.setAttributeNode(ie(e, c.item(d), !0));
            break;
          case s:
            n = !0;
        }
        if (n) {
          var p = t.firstChild;
          while (p) r.appendChild(ie(e, p, n)), (p = p.nextSibling);
        }
        return r;
      }
      function ae(e, t, n) {
      ...
      (w.prototype = Error.prototype),
        ...
        (A.prototype = {
          ...
          setNamedItem: function(e) {
            ...
            if (t && t != this._ownerElement) throw new w(k);
          ...
          setNamedItemNS: function(e) {
            var t,
              n = e.ownerElement;
            if (n && n != this._ownerElement) throw new w(k);
            return (
              (t = this.getNamedItemNS(e.namespaceURI, e.localName)),
              _(this._ownerElement, this, e, t),
              t
            );
          },
        ...
        (H.prototype = {
          ...
          appendChild: function(e) {
            return e.nodeType === m ? this.insertBefore(e, null) : K(this, e);
          },
        ...
        (O.prototype.getElementsByTagName = H.prototype.getElementsByTagName),
    ...
    "74b3": function(e, t) {
      function n(e, t) {
        ...
        (n = o(n, r, c, u, t[0], 7, -680876936)),
          ...
          (r = o(r, c, u, n, t[15], 22, 1236535329)),
          (n = i(n, r, c, u, t[1], 5, -165796510)),
          ...
          (r = i(r, c, u, n, t[12], 20, -1926607734)),
          (n = a(n, r, c, u, t[5], 4, -378558)),
          ...
          (r = a(r, c, u, n, t[2], 23, -995338651)),
          (n = s(n, r, c, u, t[0], 6, -198630844)),
    ...
    "75f1": function(e, t, n) {
      ...
      function u(e, t) {
        ...
        o.each(n, function(e, t) {
          0 === t.indexOf("x-cos-grant-") && (n[t] = W(n[t]));
        }),
          Y.call(
            this,
            {
      ...
      function L(e, t) {
        var n = e.Objects || [],
          r = e.Quiet;
        n = o.isArray(n) ? n : [n];
        var i = o.json2xml({ Delete: { Object: n, Quiet: r || !1 } }),
          a = e.Headers;
        (a["Content-Type"] = "application/xml"),
          (a["Content-MD5"] = o.binaryBase64(o.md5(i)));
      ...
      function H(e, t) {
        for (
          ...
          0 !== i[a]["ETag"].indexOf('"') &&
            (i[a]["ETag"] = '"' + i[a]["ETag"] + '"');
        var c = o.json2xml({ CompleteMultipartUpload: { Part: i } }),
          u = e.Headers;
        (u["Content-Type"] = "application/xml"),
          (u["Content-MD5"] = o.binaryBase64(o.md5(c))),
          Y.call(
            this,
            {
      ...
      function Q(e, t) {
        var n = function(e) {
          ...
          a = e.Region || "",
          s = e.Key || "";
        r.options.ForcePathStyle && i && (s = i + "/" + s);
        var c = {},
          u = e.Scope;
        if (!u) {
          var l = e.Action || "",
            d = e.ResourceKey || e.Key || "";
          u = e.Scope || [{ action: l, bucket: i, region: a, prefix: d }];
        }
        var p = o.md5(JSON.stringify(u));
        (r._StsCache = r._StsCache || []),
          (function() {
            ...
            for (e = r._StsCache.length - 1; e >= 0; e--)
              if (
                ((t = r._StsCache[e]),
                t.ExpiredTime < Math.round(Date.now() / 1e3) + 10)
              )
                r._StsCache.splice(e, 1);
              else if (!t.ScopeLimit || (t.ScopeLimit && t.ScopeKey === p)) {
                c = t;
                break;
              }
          })();
        var f = function() {
          var t = o.getAuth({
            ...
            i = {
              Authorization: t,
              XCosSecurityToken: c.XCosSecurityToken || "",
              Token: c.Token || "",
              ClientIP: c.ClientIP || "",
              ClientUA: c.ClientUA || ""
            };
        ...
        if (c.ExpiredTime && c.ExpiredTime - Date.now() / 1e3 > 60) f();
          ...
          if (!r.options.getSTS)
            return (function() {
              var t = o.getAuth({
                ...
                i = {
                  Authorization: t,
                  XCosSecurityToken: r.options.XCosSecurityToken
                };
              return n(i), i;
            })();
          r.options.getSTS.call(r, { Bucket: i, Region: a }, function(e) {
            (c = e || {}),
              (c.Scope = u),
              (c.ScopeKey = p),
              (c.TmpSecretId = c.SecretId),
              (c.TmpSecretKey = c.SecretKey),
              r._StsCache.push(c),
              f();
          });
        }
        ...
        if (!i || n._isRunningTask(i)) {
          ...
          var m = r(h, function(e, r, a) {
              ...
              if (e) c({ error: e });
                ...
                d
                  ? (f && ((u = {}), (u.body = a)),
                    u.Error ? c({ error: u.Error }) : c(null, u))
                  : c({ error: u.Error || u });
              }
            }),
            y = function(e) {
      ...
      var ee = {
        ...
        deleteBucketLifecycle: k,
        putBucketVersioning: w,
      ...
      e.exports.init = function(e, t) {
        t.transferToTaskMethod(ee, "putObject"),
          o.each(ee, function(t, n) {
                ...
                for (var d in r)
                  if (r.hasOwnProperty(d))
                    if (r[d] instanceof Array)
                      for (var p = 0; p < r[d].length; p++)
                        r[d].hasOwnProperty(p) &&
                          l.push(
                            n(
                              d,
                              e(r[d][p], 0, i + 1),
        ...
        l = {
          elUploadCloud: function(e) {
            ...
            return new Promise(function(e, n) {
              ...
              t.size > 1048576 ? c.sliceUploadFile(d, l) : c.putObject(d, l);
            });
          },
          elUpload: function(e) {
            var t =
      ...
      var r = n("b383"),
        o = (function() {
                ...
                if (null != (o = arguments[s]))
                  for (r in o)
                    (e = a[r]),
                      (n = o[r]),
                      a !== n &&
                        (u && n && (l.isPlainObject(n) || (t = l.isArray(n)))
                          ? (t
          ...
          (l.Callbacks = function(e) {
            e = "string" === typeof e ? k[e] || w(e) : l.extend({}, e);
            var t,
              n,
              r,
              o,
              ...
              u = function(l) {
                ...
                (t = !1),
                  s &&
                    (c ? c.length && u(c.shift()) : n ? (s = []) : d.disable());
              },
              d = {
                add: function() {
                  if (s) {
            ...
            l.extend({
              ...
              when: function(e) {
                var n,
                  ...
                  a = t.call(arguments),
                  s = a.length,
                  c = 1 !== s || (e && l.isFunction(e.promise)) ? s : 0,
                  u = 1 === c ? e : l.Deferred(),
                  d = function(e, r, o) {
                    return function(i) {
                      (r[e] = this),
                  ...
                  for (
                    ...
                    a[i] && l.isFunction(a[i].promise)
                      ? a[i]
                          ...
                          .progress(d(i, r, n))
                      : --c;
                return c || u.resolveWith(o, a), u.promise();
              }
            }),
          ...
          function P(t, n, r, o) {
            if (l.acceptData(t)) {
              ...
              if (
                ...
                return (
                  d || (d = c ? (t[s] = e.pop() || l.guid++) : s),
                  u[d] || (u[d] = c ? {} : { toJSON: l.noop }),
                  ("object" !== typeof n && "function" !== typeof n) ||
                    (o
                      ? (u[d] = l.extend(u[d], n))
                      : (u[d].data = l.extend(u[d].data, n))),
                  (a = u[d]),
          ...
          l.extend({
                  ...
                  if (
                    ...
                    while (n--)
                      a[n] &&
                        ((r = a[n].name),
                        0 === r.indexOf("data-") &&
                          ((r = l.camelCase(r.slice(5))), N(i, r, o[r])));
            ...
            (l.event = {
                    ...
                    (i = L.exec(t[s]) || []),
                      ...
                      h &&
                        ...
                        (f = a[h]) ||
                          ((f = a[h] = []),
                          (f.delegateCount = 0),
                          (u.setup && !1 !== u.setup.call(e, r, g, d)) ||
                            (e.addEventListener
                  ...
                  while (u--)
                    if (
                      ...
                      c &&
                        !f.length &&
                        ((p.teardown &&
                          !1 !== p.teardown.call(e, g, y.handle)) ||
                          l.removeEvent(e, h, y.handle),
                        delete d[h]);
                    } else for (h in d) l.event.remove(e, h + t[u], n, r, !0);
                  l.isEmptyObject(d) &&
              ...
              trigger: function(e, t, n, r) {
                ...
                if (
                  ...
                  if (!r && !u.noBubble && !l.isWindow(n)) {
                    for (
                      c = u.delegateType || h,
                        M.test(c + h) || (a = a.parentNode);
                      a;
                      a = a.parentNode
                    )
                      f.push(a), (d = a);
                    d === (n.ownerDocument || y) &&
                      f.push(d.defaultView || d.parentWindow || window);
                  }
                  p = 0;
                  while ((a = f[p++]) && !e.isPropagationStopped())
              ...
              dispatch: function(e) {
                ...
                if (
                  ...
                  (s = l.event.handlers.call(this, e, u)), (n = 0);
            ...
            (l.removeEvent = y.removeEventListener
              ...
              : function(e, t, n) {
                  var r = "on" + t;
                  e.detachEvent &&
                    (typeof e[r] === A && (e[r] = null), e.detachEvent(r, n));
                }),
          ...
          var q,
            ...
            X = /([?&])_=[^&]*/,
            $ = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
            W = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/,
            J = /^(?:GET|HEAD)$/,
            Q = /^\/\//,
            Y = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,
            Z = {},
                  ...
                  if (!0 !== a)
                    if (a && e["throws"]) t = a(t);
                      ...
                      try {
                        ...
                        return {
                          state: "parsererror",
                          error: a ? be : "No conversion from " + c + " to " + i
                        };
                      }
                }
            ...
            l.extend({
              ...
              ajax: function(e, t) {
                ...
                var n,
                  ...
                  d = l.ajaxSetup({}, t),
                  p = d.context || d,
                  f = d.context && (p.nodeType || p.jquery) ? l(p) : l.event,
                  h = l.Deferred(),
                  ...
                  k = {
                    ...
                    getResponseHeader: function(e) {
                      ...
                      if (2 === C) {
                        if (!u) {
                          u = {};
                          while ((t = $.exec(i))) u[t[1].toLowerCase()] = t[2];
                        }
                        t = u[e.toLowerCase()];
                      }
                    ...
                    abort: function(e) {
                      var t = e || b;
                      return c && c.abort(t), w(0, t), this;
                    }
                  };
                if (
                  ((h.promise(k).complete = g.add),
                  (k.success = k.done),
                  (k.error = k.fail),
                  (d.url = ((e || d.url || G) + "")
                    .replace(V, "")
                ...
                d.ifModified &&
                  (l.lastModified[o] &&
                    k.setRequestHeader("If-Modified-Since", l.lastModified[o]),
                  l.etag[o] && k.setRequestHeader("If-None-Match", l.etag[o])),
                ((d.data && d.hasContent && !1 !== d.contentType) ||
                  t.contentType) &&
                  k.setRequestHeader("Content-Type", d.contentType),
                d.headers))
                  k.setRequestHeader(r, d.headers[r]);
                if (
                  d.beforeSend &&
                  (!1 === d.beforeSend.call(p, k, d) || 2 === C)
                )
                  return k.abort();
                for (r in ((b = "abort"),
                ...
                function w(e, t, n, r) {
                  ...
                  2 !== C &&
                    ...
                    (k.statusText = (t || w) + ""),
                    u
                      ? h.resolveWith(p, [y, w, k])
                      : h.rejectWith(p, [k, w, v]),
                    k.statusCode(m),
                    (m = void 0),
                    s &&
          ...
          function pe(e, t, n, r) {
            ...
            else for (o in t) pe(e + "[" + o + "]", t[o], n, r);
          }
          ...
          if (
            ...
            e.body &&
              (e.body instanceof Blob ||
                "[object File]" === e.body.toString() ||
                "[object Blob]" === e.body.toString() ||
      ...
      function h(e, t, n, r, o) {
        ...
        function s(t) {
          if (t > b) {
            ...
            p && c(b), r.characters(n, 0, t - b), (b = t);
          }
        }
        function c(t, n) {
          while (t >= l && (n = d.exec(e)))
            (u = n.index), (l = u + n[0].length), p.lineNumber++;
            ...
            switch ((S > b && s(S), e.charAt(S + 1))) {
              case "/":
                var A = e.indexOf(">", S + 3),
                  ...
                  _ = f.pop();
                A < 0
                  ? ((E = e.substring(S + 2).replace(/[\s<].*/, "")),
                    o.error(
                      "end tag name: " + E + " is not complete:" + _.tagName
                    ),
                    (A = S + 1 + E.length))
                  : E.match(/\s</) &&
                    ((E = E.replace(/[\s<].*/, "")),
                    o.error("end tag name: " + E + " maybe not complete"),
                    (A = S + 1 + E.length));
                var N = _.localNSMap,
                  B = _.tagName == E,
                  P =
                    B ||
                    (_.tagName && _.tagName.toLowerCase() == E.toLowerCase());
                if (P) {
                  if ((r.endElement(_.uri, _.localName, E), N))
                    for (var I in N) r.endPrefixMapping(I);
                  B ||
                    o.fatalError(
                      "end tag name: " +
                        E +
              ...
              default:
                p && c(S);
                var D = new w(),
                  O = f[f.length - 1].currentNSMap,
                  j = ((A = m(e, S, D, O, a, o)), D.length);
                if (
                  (!D.closed &&
                    C(e, A, D.tagName, h) &&
                    ((D.closed = !0),
                  ...
                  for (var M = g(p, {}), L = 0; L < j; L++) {
                    var U = D[L];
                    c(U.offset), (U.locator = g(p, {}));
                  }
                  (r.locator = M), y(D, r, O) && f.push(D), (r.locator = p);
                } else y(D, r, O) && f.push(D);
                "http://www.w3.org/1999/xhtml" !== D.uri || D.closed
                  ? A++
                  : (A = v(e, A, D.tagName, a, r));
            }
          } catch (F) {
            o.error("element parse error: " + F), (A = -1);
          }
          A > b ? (b = A) : s(Math.max(S, b) + 1);
        }
      }
      function g(e, t) {
        return (
            ...
            case ">":
              switch (m) {
                ...
                case s:
                  m === s && (v = h),
                    m == u
                      ? (f.warning('attribute "' + v + '" missed quot(")!!'),
              ...
              if (y <= " ")
                ...
                switch (m) {
                  case s:
                    ...
                    break;
                  case l:
                    f.warning('attribute space is required"' + h + '"!!');
                  case d:
                    (m = a), (t = g);
                    break;
                  case c:
      ...
      function y(e, t, n) {
        ...
        while (i--) {
          var a = e[i],
            ...
            u = s.indexOf(":");
          if (u > 0)
            var l = (a.prefix = s.slice(0, u)),
              d = s.slice(u + 1),
              p = "xmlns" === l && d;
          else (d = s), (l = null), (p = "xmlns" === s && "");
          (a.localName = d),
            !1 !== p &&
              (null == o && ((o = {}), b(n, (n = {}))),
              (n[p] = o[p] = c),
        ...
        u = r.indexOf(":");
        u > 0
          ? ((l = e.prefix = r.slice(0, u)), (d = e.localName = r.slice(u + 1)))
          : ((l = null), (d = e.localName = r));
        var f = (e.uri = n[l || ""]);
        if ((t.startElement(f, d, r, e), !e.closed))
          return (e.currentNSMap = n), (e.localNSMap = o), !0;
        if ((t.endElement(f, d, r), o)) for (l in o) t.endPrefixMapping(l);
      }
              ...
              if (o) {
                ...
                if (
                  ...
                  (o.state = r),
                    ...
                    c(),
                    s && (i--, u(e)),
                    "canceled" === r && (delete o.params, delete o.callback);
                }
              }
            };
          (e._addTasks = function(t) {
            ...
            (e._addTask = function(o, i, s, l) {
              ...
              i.onHashProgress = function(t) {
                e._isRunningTask(p.id) &&
                  ((p.hashPercent = t.percent), f && f(t), c());
              };
              var h = i.onProgress;
              return (
                (i.onProgress = function(t) {
                  e._isRunningTask(p.id) &&
                    ("checking" === p.state && (p.state = "uploading"),
                    (p.loaded = t.loaded),
                    (p.speed = t.speed),
                    (p.percent = t.percent),
                    h && h(t),
                ...
                r.getFileSize(o, i, function(r, o) {
                  if (r) s(r);
                    ...
                    if (
                      ...
                      var i = t.length - e.options.UploadQueueSize;
                      t.splice(0, i), (a -= i);
                    }
                    (p.size = o), !l && c(), u(e);
                  }
            ...
            (e.restartTask = function(e) {
              ...
              !t ||
                ...
                ((t.state = "waiting"), c(), (a = Math.min(a, t.index)), u());
            });
        };
...
//# sourceMappingURL=chunk-d1906302.53688e55.js.map
